...
<section class="mb-[500px] mt-[200px]">
	<div class="relative px-16">
		...
		>
			...
			<p class="mt-6 text-base text-bc-black1">
				Read about our ideas and we think connecting young people to nature is a great idea.
			</p>
